...
const ControlBase = React.forwardRef((_a, ref) => {
  var _b = _a, { className, active, icon: Icon } = _b, others = __objRest(_b, ["className", "active", "icon"]);
  return /* @__PURE__ */ React__default.createElement(Control.Control, __spreadValues({
    active,
    ref
