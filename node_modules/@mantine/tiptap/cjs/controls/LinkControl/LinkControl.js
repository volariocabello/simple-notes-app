...
const LinkIcon = (_a) => {
  ...
  return /* @__PURE__ */ React__default.createElement(icons.IconLink, __spreadValues({
    size,
    stroke: 1.5
  }, others));
};
...
const LinkControl = React.forwardRef((props, ref) => {
  ...
  const { editor, labels, classNames, styles, unstyled } = RichTextEditor_context.useRichTextEditorContext();
  const { classes } = LinkControl_styles['default'](null, { name: "RichTextEditor", classNames, styles, unstyled });
  ...
  return /* @__PURE__ */ React__default.createElement(core.Popover, __spreadValues({
    ...
    rightSection: /* @__PURE__ */ React__default.createElement(core.Tooltip, {
      ...
      unstyled
    }, /* @__PURE__ */ React__default.createElement(icons.IconExternalLink, {
      size: 14,
      stroke: 1.5
    })))
