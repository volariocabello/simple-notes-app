...
const UnsetColorControl = createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(IconCircleOff, __spreadProps(__spreadValues({}, props), {
    stroke: 1.5
  })),
