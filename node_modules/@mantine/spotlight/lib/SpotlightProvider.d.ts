...
export declare function SpotlightProvider({ actions: initialActions, children, shortcut, onSpotlightClose, onSpotlightOpen, onQueryChange, cleanQueryOnClose, transitionDuration, disabled, tagsToIgnore, triggerOnContentEditable, ...others }: SpotlightProviderProps): JSX.Element;
